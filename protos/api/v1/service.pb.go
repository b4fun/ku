...
var file_api_v1_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x6a, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x50, 0x61, 0x72, 0x73, 0x65, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x73, 0x71, 0x6c, 0x22, 0x46, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72,
	0x73, 0x65, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x29, 0x0a, 0x07, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x52, 0x07, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x32, 0xcc, 0x02, 0x0a, 0x0a,
	0x41, 0x50, 0x49, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4b, 0x0a, 0x0c, 0x4c, 0x69,
	0x73, 0x74, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x1b, 0x2e, 0x61, 0x70, 0x69,
	...
	0x65, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	...
	0x65, 0x50, 0x61, 0x72, 0x73, 0x65, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x20, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x73,
	0x65, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x21,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x61,
	0x72, 0x73, 0x65, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
...
var file_api_v1_service_proto_goTypes = []interface{}{
	...
	(*CreateParsedTableRequest)(nil),  // 6: api.v1.CreateParsedTableRequest
	(*CreateParsedTableResponse)(nil), // 7: api.v1.CreateParsedTableResponse
	(*Session)(nil),                   // 8: api.v1.Session
	(*TableRow)(nil),                  // 9: api.v1.TableRow
	(*TableColumn)(nil),               // 10: api.v1.TableColumn
}
var file_api_v1_service_proto_depIdxs = []int32{
	8,  // 0: api.v1.ListSessionsResponse.sessions:type_name -> api.v1.Session
	9,  // 1: api.v1.QueryTableResponse.rows:type_name -> api.v1.TableRow
	10, // 2: api.v1.QueryTableResponse.columns:type_name -> api.v1.TableColumn
	8,  // 3: api.v1.UpdateSessionRequest.session:type_name -> api.v1.Session
	8,  // 4: api.v1.UpdateSessionResponse.session:type_name -> api.v1.Session
	8,  // 5: api.v1.CreateParsedTableResponse.session:type_name -> api.v1.Session
	0,  // 6: api.v1.APIService.ListSessions:input_type -> api.v1.ListSessionsRequest
	4,  // 7: api.v1.APIService.UpdateSession:input_type -> api.v1.UpdateSessionRequest
	6,  // 8: api.v1.APIService.CreateParsedTable:input_type -> api.v1.CreateParsedTableRequest
	2,  // 9: api.v1.APIService.QueryTable:input_type -> api.v1.QueryTableRequest
	1,  // 10: api.v1.APIService.ListSessions:output_type -> api.v1.ListSessionsResponse
	5,  // 11: api.v1.APIService.UpdateSession:output_type -> api.v1.UpdateSessionResponse
	7,  // 12: api.v1.APIService.CreateParsedTable:output_type -> api.v1.CreateParsedTableResponse
	3,  // 13: api.v1.APIService.QueryTable:output_type -> api.v1.QueryTableResponse
...
func file_api_v1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateParsedTableRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateParsedTableResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
